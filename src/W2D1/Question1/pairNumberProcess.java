...
//			printListOfkeyValuePair(list);
	...
	//System.out.println(partitionPairs);
		...
		for (int i = 0; i < reducer.length; i++) {
			...
			System.out.println("\n_____________Reducer " + i
					+ " Output_____________\n");
			List<keyValuePair<keyValuePair<Integer,Integer>, Float>> reducerOutput = reducer
...
//		System.out.println(shuffledKeysList);
	...
	private void printKeyValue(List<keyValuePair<keyValuePair<Integer, Integer>,Float>> reducerOutput) {
		// TODO Auto-generated method stub
		if(reducerOutput !=null)
		{
			for(keyValuePair<keyValuePair<Integer,Integer>,Float> item : reducerOutput)
			{
