...
public class Main {
	public static void main(String[] args) {
		...
		for (String txt : res) {
			m1.addElement(new keyValuePair<PairedKey<String>, Integer>(
					new PairedKey<String>(txt, "112"), 1));
		}
		...
		for (String txt : res) {
			m1.addElement(new keyValuePair<PairedKey<String>, Integer>(
					new PairedKey<String>(txt, "234"), 1));
		}
		...
		for (String txt : res) {
			m1.addElement(new keyValuePair<PairedKey<String>, Integer>(
					new PairedKey<String>(txt, "356"), 1));
		}
		...
		for (String txt : res) {
			m1.addElement(new keyValuePair<PairedKey<String>, Integer>(
					new PairedKey<String>(txt, "679"), 1));
		}
		...
		for (Reducer<PairedKey<String>, Integer> r : h.getReducers()) {
			System.out.println("Redcuer " + redIdx + " output");
			for (Entry<PairedKey<String>, ArrayList<Integer>> ele : r
